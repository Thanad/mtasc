...
val dump_code : 'a IO.output -> 'b -> jcode -> unit
val dump_attrib : 'a IO.output -> 'b -> attribute -> unit
val dump_field : 'a IO.output -> 'b -> jfield -> unit
val dump_method : 'a IO.output -> 'b -> jmethod -> unit
