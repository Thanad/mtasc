...
let opcode = function
	...
	| OpSIPush n -> sprintf "sipush %d" n
	| OpLdc1 n -> sprintf "lcd1 %d" n
	| OpLdc2 n -> sprintf "lcd2 %d" n
	| OpLdc2w n -> sprintf "lcd2w %d" n
	...
	| OpD2L -> "d2l"
	| OpD2F -> "d2f"
	| OpIntToByte -> "inttobyte"
	| OpIntToChar -> "inttochar"
	| OpIntToShort -> "inttoshort"
